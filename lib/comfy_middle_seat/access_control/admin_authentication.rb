...
module ComfyMiddleSeat::AccessControl
  module AdminAuthentication
    # Set username and password in config/initializers/comfy_middle_seat.rb
    # Like this:
    #   ComfyMiddleSeat::AccessControl::AdminAuthentication.username = 'myname'
    #   ComfyMiddleSeat::AccessControl::AdminAuthentication.password = 'mypassword'
