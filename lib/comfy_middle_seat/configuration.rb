...
class ComfyMiddleSeat::Configuration
  # Don't like ComfyMiddleSeat? Set it to whatever you like. :(
  ...
  def initialize
    @cms_title              = 'ComfyMiddleSeat CMS Engine'
    @admin_base_controller  = 'ApplicationController'
    @public_base_controller = 'ApplicationController'
    @admin_auth             = 'ComfyMiddleSeat::AccessControl::AdminAuthentication'
    @admin_authorization    = 'ComfyMiddleSeat::AccessControl::AdminAuthorization'
    @public_auth            = 'ComfyMiddleSeat::AccessControl::PublicAuthentication'
    @public_authorization   = 'ComfyMiddleSeat::AccessControl::PublicAuthorization'
    @seed_data_path         = nil
