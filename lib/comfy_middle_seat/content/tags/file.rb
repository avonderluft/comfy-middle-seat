...
#
class ComfyMiddleSeat::Content::Tags::File < ComfyMiddleSeat::Content::Tags::Fragment
  include ComfyMiddleSeat::Content::Tags::Mixins::FileContent
  ...
  # @param (see ComfyMiddleSeat::Content::Tag#initialize)
