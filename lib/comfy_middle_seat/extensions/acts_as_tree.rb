...
module ComfyMiddleSeat::Extensions::ActsAsTree
  ...
  module ClassMethods
    def cms_acts_as_tree(options = {})
      ...
      class_eval <<-RUBY, __FILE__, __LINE__ + 1
        include ComfyMiddleSeat::Extensions::ActsAsTree::InstanceMethods
...
ActiveSupport.on_load :active_record do
  include ComfyMiddleSeat::Extensions::ActsAsTree
end
