...
module ComfyMiddleSeat::Extensions::HasRevisions
  ...
  module ClassMethods
    def cms_has_revisions_for(*fields)
      include ComfyMiddleSeat::Extensions::HasRevisions::InstanceMethods
  ...
  module InstanceMethods
    ...
    def create_revision
      ...
      limit = ComfyMiddleSeat.config.revisions_limit.to_i
...
ActiveSupport.on_load :active_record do
  include ComfyMiddleSeat::Extensions::HasRevisions
end
