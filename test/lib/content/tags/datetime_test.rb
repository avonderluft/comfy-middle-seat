...
class ContentTagsDatetimeTest < ActiveSupport::TestCase
  ...
  def test_content
    tag = ComfyMiddleSeat::Content::Tags::Datetime.new(context: @page, params: [@frag.identifier])
  ...
  def test_render_with_strftime
    ...
    tag = ComfyMiddleSeat::Content::Tags::Datetime.new(context: @page, params: params)
    assert_equal 'at 12:34PM', tag.render
  end

  def test_render_not_renderable
    tag = ComfyMiddleSeat::Content::Tags::Datetime.new(
      context: @page,
