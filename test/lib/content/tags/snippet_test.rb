...
class ContentTagsSnippetTest < ActiveSupport::TestCase
  ...
  def test_init
    tag = ComfyMiddleSeat::Content::Tags::Snippet.new(context: @page, params: ['default'])
  ...
  def test_init_without_identifier
    ...
    error = assert_raises ComfyMiddleSeat::Content::Tag::Error do
      ComfyMiddleSeat::Content::Tags::Snippet.new(context: @page)
    end
    assert_equal message, error.message
  end

  def test_snippet_new_record
    tag = ComfyMiddleSeat::Content::Tags::Snippet.new(context: @page, params: ['new'])
  ...
  def test_markdown_content
    tag = ComfyMiddleSeat::Content::Tags::Snippet.new(context: @page, params: ['markdown'])
